package org.synthful.gwt.json.client;
...
abstract public class JsonRemoteScriptCall
{
    ...
    public void calByCallBackParameter( String url, String callBackParameter )
    {
    ...
    /*-{
        jsonRSCcallback = function( j ){
            hdlr.@org.synthful.gwt.json.client.JsonRemoteScriptCall::onJsonRSCResponse(Lcom/google/gwt/core/client/JavaScriptObject;)( j );
        };
